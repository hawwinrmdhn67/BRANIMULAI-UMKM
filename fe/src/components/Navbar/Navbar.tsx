...
interface NavbarProps {
  currentPage: "home" | "admin" | "hotspot" | "seller";
  onNavigate: (page: "home" | "admin" | "hotspot" | "seller") => void;
  pendingCount?: number;
}
        ...
        <div className="container mx-auto px-4 h-full">
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant={currentPage === "seller" ? "secondary" : "ghost"}
              ...
              <Button
                variant={currentPage === "hotspot" ? "secondary" : "ghost"}
                onClick={() => onNavigate("hotspot")}
                className={currentPage === "hotspot" ? "" : "text-white hover:bg-green-700"}
              >
