...
export const Footer = () => {        
    return (
        <footer className="w-full py-16 bg-primary">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 lg:col-span-1">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><a href="#" className="text-white text-sm hover:text-green-200 transition-colors">Customer Support</a></li>
                                <li><a href="#" className="text-white text-sm hover:text-green-200 transition-colors">Syarat & Ketentuan</a></li>
                                <li><a href="#" className="text-white text-sm hover:text-green-200 transition-colors">Kebijakan Privasi</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-green-700">
                    <p className="text-sm text-center text-white">
                        © Copyright 2025 || All Rights Reserved by BraniMulai
                    </p>
                </div>
            </div>
        </footer>
